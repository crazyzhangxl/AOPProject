package com.example.aopproject.arouter.testinterceptor;
...
import com.example.aopproject.MainActivity;
import com.example.aopproject.arouter.ARouterMainActivity;
import com.example.aopproject.arouter.MainLooper;
...
public class Test1Interceptor implements IInterceptor {
    ...
    public void process(final Postcard postcard, final InterceptorCallback callback) {
        if ("/test/activity4".equals(postcard.getPath())) {
            ...
            final AlertDialog.Builder ab = new AlertDialog.Builder(ARouterMainActivity.getThis());
